  ...
  return (
    <div className="mb-4 transform md:scale-100 scale-90">
      <input
		...
		disabled={disabled}
        type={type}
			  className={`z-10 form-control block w-full px-4 py-2 text-lg ${disabled &&
		...
		font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
		 rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-secondary focus:outline-none`}
        id={placeholder}
